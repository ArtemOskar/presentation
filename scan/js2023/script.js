...
let subMenuTravelBtn = document.querySelector('.travel-menu-list__btn-close')
let subMenuDesignBtn = document.querySelector('.design-menu-list__btn-close')
...
function clickAction(event) {
   ...
   if (targetClick.closest('.travel-menu-item') && body.classList.contains('touch')) {
      ...
      subMenuTravelBtn.classList.add('visible')
   } else {
   ...
   if (targetClick.closest('.design-menu-item') && body.classList.contains('touch')) {
      ...
      subMenuDesignBtn.classList.add('visible')
   } else {
